...
class StreamManagerApp:
    ...
    def load_config(self, config):
        ...
        self.set_entry_value(self.youtube_ingest_main, config.get("youtube_primary_ingress_url", ""))
        self.set_entry_value(self.youtube_ingest_backup, config.get("youtube_backup_ingress_url", ""))
        self.set_entry_value(self.youtube_stream_key, config.get("youtube_stream_key", ""))
        self.set_entry_value(self.twitch_ingest_url, config.get("twitch_ingress_url", ""))
    ...
    def validate_config(self, config):
        required_fields = ["incoming_app", "incoming_port", "youtube_primary_ingress_url", "youtube_stream_key", "twitch_ingress_url", "twitch_key"]
